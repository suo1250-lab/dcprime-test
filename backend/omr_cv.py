...
LAYOUT = {
    # 상단 ID 섹션
    # ※ 실제 스캔본 기준: 기타란 + 학번 마킹 영역 합산 약 28%
    "id": {
        "y": (0.02, 0.27),    # 세로 범위 (헤더 전체 커버)
        "x": (0.03, 0.86),    # 가로 범위 (타이밍마크 제외)
        "rows": 5,             # 행: 학년 / 반십 / 반일 / 번호십 / 번호일
        "cols": 10,            # 열: 숫자 0 ~ 9
    },
    # 답안 4섹션 (각 10문항 × 5지선다)
    # ※ 헤더가 약 28% → 답안 섹션 각 15%, 섹션간 갭 2%
    "answer_sections": [
        {"y": (0.28, 0.44), "q_range": (1,  10)},
        {"y": (0.46, 0.62), "q_range": (11, 20)},
        {"y": (0.64, 0.79), "q_range": (21, 30)},
        {"y": (0.80, 0.94), "q_range": (31, 40)},
    ],
